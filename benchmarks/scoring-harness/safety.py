...
DENOM_RULES = {
    ...
    "TC-015": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-016": {"expected_pop": "SAFETY", "expected_flag": "SAFFL"},
    "TC-017": {"expected_pop": "SAFETY", "expected_flag": "SAFFL"},
    "TC-018": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-019": {"expected_pop": "SAFETY", "expected_flag": "SAFFL"},
    "TC-020": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-021": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-022": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-023": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-024": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-025": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-026": {"expected_pop": "ITT", "expected_flag": "ITTFL"},
    "TC-027": {"expected_pop": "ITT_BOR_SD", "expected_flag": "ITTFL"},
}
